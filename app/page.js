...
export default function Home() {
  ...
  return (
    <div className="relative z-0">
      <AnimatedBackground />
      <div className="flex flex-col lg:flex-row gap-5 justify-between bg-gradient-to-b from-gray-900 relative z-0">
        ...
        <div className="lg:w-[90vw] lg:h-[90vh] w-[50vw] h-[20vh] overflow-hidden relative m-2 p-2">
          <Image
            src="/main.png"
