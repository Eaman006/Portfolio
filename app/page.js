  ...
  return (
    <div className="flex gap-5 justify-between bg-gradient-to-b from-gray-800">
      <div className="m-5 w-2/3 pt-5">
        <div className="bg-black p-2 mt-2 rounded-xl text-xl border-2 border-blue-400 w-fit flex">👋Hi there, I'm <div className="text-blue-400 px-2 font-bold">Eaman</div></div>
